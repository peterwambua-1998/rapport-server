...
// Middleware for handling both coverPhoto and profilePhoto
const uploadImagesMiddleware = upload.fields([
  { name: 'coverPhoto', maxCount: 1 }, // Allows one file for coverPhoto
  { name: 'profilePhoto', maxCount: 1 } // Allows one file for profilePhoto
]);
