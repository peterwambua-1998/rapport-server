...
createDirectoryIfNotExists("uploads/qtnVideos");

// Configure storage
const storage = multer.diskStorage({
  destination: function (req, file, cb) {
    if (file.mimetype.startsWith("video/")) {
      cb(null, "uploads/qtnVideos/");
    } else {
...
const interviewQuestionMiddleware = upload.fields([
  { name: "video", maxCount: 1 }, // Allows one file for video
]);

module.exports = interviewQuestionMiddleware;
